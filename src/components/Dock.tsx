...
// Todo-dinesh
// 1.enable dock hiding - for now, we will keep hidden unless cursor is hovered over certain area of the bottom screen
// later, it should only hide if dock is restricting any window, just like normal os.
